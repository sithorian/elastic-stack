...
# I strongly suggest you to use this script in a host which has at least 8 CPU cores with at least 32 GB of memory. By default the script will reserve 12 GB of memory for additional components and OS. The rest will be distributed between Elasticsearch node(s).
